...
especifico, luego de haber hecho los ajustes necesarios usamos el comando de npm run start :dev para correr el programa,
una vez ejecutado, debemos abrir nuestro pgadmin y comprobar que la base de datos tenga guardado la nueva tabla
que agragamos.
